...
def show_range_image(frame, lidar_name):
    ...
    deg90 = int(ri_range.shape[1] / 2)
    ri_center = int(ri_range.shape[1]/2)
    print (ri_center-deg90, ri_center+deg90)
    ri_range = ri_range[:, np.arange(ri_center-deg90, ri_center+deg90-2, 2)]
    ...
    deg90 = int(ri_intensity.shape[1] / 2)
    ri_center = int(ri_intensity.shape[1]/2)
    ri_intensity = ri_intensity[:, np.arange(ri_center-deg90, ri_center+deg90-2, 2)]
